        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="panel-group" id="accordion">
              ...
              {{ Form::radio('card', $card->id, false, array('id'=>$card->id))}}
              ...
              <div class="col-lg-6">
                  ...
                  <div class="col-sm-offset-2 col-sm-10">
                    <div class="checkbox">
                      <label style="text-align: justify;">
                        <input type="checkbox" name="agr0" id="agr0" required="required"> Je certifie être inscrit au registre des auto-entrepreneurs ou des entrepises individuelles et être à jour de mes cotisations et déclarations sociales
                      </label><br>                      
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    <div class="checkbox">
                      <label style="text-align: justify;">
                        <input type="checkbox" name="agr1" id="agr1" required="required">Je m'engage à respecter strictement le code de la route. J'atteste avoir été formé à la conduite et à la sécurité (la mienne, celle des tiers et celle des passagers). J'ai compris qu'en cas d'infraction aux règles de sécurité et au code de la route, je serais seul responsable et pourrais ne pas être couvert pas l'assurance proposée par Cyclopolitain.

                      </label><br>                      
                        <label id="agr1-error" for="agr1" class="error" style="display: none; font-weight: 700 !important; font-weight: 700 !important;">Ce champ est requis.</label>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="agr2" id="agr2" required="required">J'ai lu et j'accepte les conditions générales <a target="_blank" href="{{url('/cgv')}}">conditions générales de location</a>

                      </label><br>                      
                        <label id="agr2-error" for="agr2" class="error" style="display: none; font-weight: 700 !important; font-weight: 700 !important;">Ce champ est requis.</label>
                    </div>
                  </div>
                </div>                
...
<script type="text/javascript">
  ...
  $form.on('submit', function(e) {
    if(!$checkbox.is(':checked')|| !$checkbox1.is(':checked') || !$checkbox2.is(':checked') ) {
      e.preventDefault();
